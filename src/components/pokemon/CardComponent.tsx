...
const CardComponent: React.FC<Pokemon> = ({ url, name }) => {
    ...
    return (
        <>
            {
                !loading && <div onClick={handleOnClickDetail} className="rounded-md shadow-lg p-5 overflow-hidden transition-all cursor-pointer border-2 border-transparent hover:border-black dark:hover:border-white" style={gradientStyle}>
