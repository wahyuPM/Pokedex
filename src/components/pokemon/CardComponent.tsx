...
const CardComponent: React.FC<Pokemon> = ({ url, name }) => {
    ...
    return (
        <>
            <div className='rounded-md bg-white dark:bg-gray-900 shadow-lg p-5 overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-black dark:hover:border-white transition-all cursor-pointer'>
            ...
            {loading && <div className='rounded-md '>
