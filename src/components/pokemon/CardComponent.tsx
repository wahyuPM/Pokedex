...
const CardComponent: React.FC<Pokemon> = ({ url, name }) => {
    ...
    return (
        <>
            {
                !loading && <div className="rounded-md shadow-lg p-5 overflow-hidden border transition-all cursor-pointer border-gray-200 dark:border-gray-700 hover:border-black dark:hover:border-white" style={gradientStyle}>
